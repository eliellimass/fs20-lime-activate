...
ObjectIds.OBJECT_TREE = nextObjectId()
ObjectIds.OBJECT_SAPLING_PALLET = nextObjectId()
...
ObjectIds.OBJECT_SILO_TRIGGER = nextObjectId()
...
ObjectIds.OBJECT_UNLOAD_FEEDING_TROUGH = nextObjectId()
ObjectIds.OBJECT_FILLLEVEL_LISTENER = nextObjectId()
ObjectIds.OBJECT_ANIMAL_HUSBANDRY = nextObjectId()
ObjectIds.OBJECT_ANIMAL_LIGHT_WILDLIFE = nextObjectId()
ObjectIds.OBJECT_ANIMAL_CROWS_WILDLIFE = nextObjectId()
ObjectIds.OBJECT_ANIMAL = nextObjectId()
ObjectIds.OBJECT_HORSE = nextObjectId()
ObjectIds.OBJECT_RIDEABLE_ANIMAL = nextObjectId()
ObjectIds.OBJECT_BUNKER_SILO = nextObjectId()
ObjectIds.OBJECT_BUNKER_SILO_TIP_TRIGGER = nextObjectId()
ObjectIds.OBJECT_TRAIN = nextObjectId()
ObjectIds.OBJECT_RAILROADVEHICLE = nextObjectId()
ObjectIds.OBJECT_BGA = nextObjectId()
ObjectIds.OBJECT_BGA_TIP_TRIGGER = nextObjectId()
ObjectIds.OBJECT_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_BALE_STORAGE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WIND_TURBINE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_SOLAR_COLLECTOR_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_BEEHIVE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_GREENHOUSE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_HIGHPRESSURE_WASHER_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_TREE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_SILO_EXTENSION_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WOOD_CRUSHER_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_HEATING_PLANT_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WORKSHOP_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_DOGHOUSE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WATERTOWER_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_SILO_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_SIMPLE_BGA_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_SELLING_STATION_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_BUYING_STATION_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_ANIMATED_OBJECT = nextObjectId()
ObjectIds.OBJECT_ANIMATED_MAP_OBJECT = nextObjectId()
ObjectIds.OBJECT_VEHICLE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_FARMHOUSE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_REFILLABLE_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_TRAIN_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WOOD_SELL_STATION_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_WASH_STATION_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_BGA_PLACEABLE = nextObjectId()
ObjectIds.OBJECT_BUNKERSILO_PLACEABLE = nextObjectId()
...
ObjectIds.OBJECT_RECIEVING_TIP_TRIGGER = nextObjectId()
