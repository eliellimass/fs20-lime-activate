...
function SmartAttach:onLoad(savegame)
	...
	local jointTypeStr = getXMLString(self.xmlFile, "vehicle.smartAttach#jointType")
	...
	local triggerNode = I3DUtil.indexToObject(self.components, getXMLString(self.xmlFile, "vehicle.smartAttach#trigger"), self.i3dMappings)
...
function SmartAttachActivatable:onActivateObject()
...
function SmartAttachActivatable:drawActivate()
end

SmartAttachEvent = {}
SmartAttachEvent_mt = Class(SmartAttachEvent, Event)
