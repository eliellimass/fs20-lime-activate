...
function CCTDrivable:onLoad(savegame)
	...
	spec.cctRadius = Utils.getNoNil(getXMLFloat(self.xmlFile, "vehicle.cctDrivable#cctRadius"), 1)
	spec.cctHeight = Utils.getNoNil(getXMLFloat(self.xmlFile, "vehicle.cctDrivable#cctHeight"), 1)
	spec.customOffset = Utils.getNoNil(getXMLFloat(self.xmlFile, "vehicle.cctDrivable#customOffset"), 0)
