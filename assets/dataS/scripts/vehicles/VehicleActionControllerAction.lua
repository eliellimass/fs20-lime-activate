...
function VehicleActionControllerAction:update(dt)
	...
	if self.deactivateFunc ~= nil and self.deactivateFunc(self.deactivateFunctionTarget) == not self.inverseDeactivateFunc and self.lastDirection == 1 and self.parent.currentSequenceIndex == nil and self.forceDirectionUntilFinished == nil then
