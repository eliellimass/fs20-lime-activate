...
function TireTrackSystem:load(id)
	...
	if g_addTestCommands then
		addConsoleCommand("gsRemoveAllTireTracks", "Remove all tire tracks from terrain", "TireTrackSystem.consoleCommandRemoveAllTireTracks", nil)
	end
...
function TireTrackSystem:delete()
	...
	removeConsoleCommand("gsRemoveAllTireTracks")
end
