...
function SettingsGeneralFrame:new(target, custom_mt, settingsModel, l10n)
	custom_mt = custom_mt or SettingsGeneralFrame_mt
	local self = TabbedMenuFrameElement:new(target, custom_mt)
...
function SettingsGeneralFrame:getMainElementSize()
	return self.settingsContainer.size
end

function SettingsGeneralFrame:getMainElementPosition()
