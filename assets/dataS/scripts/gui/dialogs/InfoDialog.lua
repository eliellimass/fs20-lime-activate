...
function InfoDialog:onClickOk()
	return self:acceptDialog(InputAction.MENU_ACCEPT, false)
end

function InfoDialog:onClickCancel()
	return self:acceptDialog(InputAction.MENU_CANCEL, false)
end

function InfoDialog:onClickActivate()
	return self:acceptDialog(InputAction.MENU_ACTIVATE, false)
end
