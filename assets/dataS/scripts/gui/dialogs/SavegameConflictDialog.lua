...
function SavegameConflictDialog:onOpen()
	SavegameConflictDialog:superClass().onOpen(self)
end
...
function SavegameConflictDialog:setSavegame(isLocal, savegame)
	if savegame ~= nil then
		...
		if isLocal then
			...
			self.local_createDate:setText(savegame.saveDate)
		else
			...
			self.cloud_createDate:setText(savegame.saveDate)
		end
	end
end
