...
InGameMenuMainFrame.CONTROLS = {
	...
	BUTTON_SETTTINGS = "buttonSettings",
	BUTTON_VEHICLES = "buttonVehicles",
	BUTTON_HELP = "buttonHelp",
	BUTTON_PRICES = "buttonPrices",
	BUTTON_FINANCES = "buttonFinances",
	BUTTON_STATISTICS = "buttonStatistics",
	BUTTON_ANIMALS = "buttonAnimals"
}
...
function InGameMenuMainFrame:onFrameOpen(element)
	...
	if g_isPresentationVersion then
		self.buttonVehicles:setDisabled(true)
		self.buttonFinances:setDisabled(true)
		self.buttonAnimals:setDisabled(true)
		self.buttonStatistics:setDisabled(true)
		self.buttonHelp:setDisabled(true)
		self.buttonPrices:setDisabled(true)
		self.buttonSettings:setDisabled(true)
	end
end
