...
function GameInfoDisplayMobile.new(hud, hudAtlasPath, moneyUnit, l10n)
	...
	local self = GameInfoDisplayMobile:superClass().new(GameInfoDisplayMobile_mt, backgroundOverlay, nil)
	self.hud = hud
	self.uiScale = 1
	...
	if g_buildTypeParam == "CHINA" or g_buildTypeParam == "CHINA_GAPP" then
		self:createButtonElement(self.onOpenStreetWarning, GameInfoDisplayMobile.POSITION.STREET_WARNING_SIGN, GameInfoDisplayMobile.SIZE.STREET_WARNING_SIGN, GameInfoDisplayMobile.SIZE.STREET_WARNING_SIGN, GameInfoDisplayMobile.UV.STREET_WARNING_SIGN, GameInfoDisplayMobile.COLOR.BUTTON, GameInfoDisplayMobile.COLOR.NO_BACKGROUND, GameInfoDisplayMobile.COLOR.BUTTON_SELECTED)
	end
...
function GameInfoDisplayMobile:onOpenStreetWarning()
	g_gui:showInfoDialog({
		text = g_i18n:getText("streetWarningDriveSafe"),
