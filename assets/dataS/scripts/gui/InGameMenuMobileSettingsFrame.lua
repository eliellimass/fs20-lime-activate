...
function InGameMenuMobileSettingsFrame:new(subclass_mt, settingsModel, messageCenter)
	local subclass_mt = subclass_mt or InGameMenuMobileSettingsFrame_mt
...
function InGameMenuMobileSettingsFrame:initialize()
	...
	self.multiGraphics:setVisible(GS_PLATFORM_TYPE == GS_PLATFORM_TYPE_ANDROID or GS_PLATFORM_TYPE == GS_PLATFORM_TYPE_IOS)
