...
function ChurchClock:new(id)
	...
	setmetatable(self, ChurchClockNew_mt)
	...
	self.hasClocks = table.getn(self.clocks) > 0
...
function ChurchClock:delete()
	if g_currentMission ~= nil and g_currentMission.environment ~= nil and self.hasClocks then
