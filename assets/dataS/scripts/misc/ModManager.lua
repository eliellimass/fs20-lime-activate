...
function ModManager:addMod(title, description, version, modDescVersion, author, iconFilename, modName, modDir, modFile, isMultiplayerSupported, fileHash, absBaseFilename, isDirectory, isDLC, isPreorderBonus)
	...
	local mod = {
		...
		isPreorderBonus = isPreorderBonus
	}
...
function ModManager:getAreAllModsAvailable(modHashs)
