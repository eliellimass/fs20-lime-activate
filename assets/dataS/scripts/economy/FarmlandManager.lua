...
function FarmlandManager:loadFarmlandData(xmlFile)
	...
	if g_currentMission:getIsServer() and g_addCheatCommands then
		addConsoleCommand("gsBuyFarmland", "Buys farmland with given id", "consoleCommandBuyFarmland", self)
		addConsoleCommand("gsBuyAllFarmlands", "Buys all farmlands", "consoleCommandBuyAllFarmlands", self)
		addConsoleCommand("gsSellFarmland", "Sells farmland with given id", "consoleCommandSellFarmland", self)
		addConsoleCommand("gsSellAllFarmlands", "Sells all farmlands", "consoleCommandSellAllFarmlands", self)
	end
...
function FarmlandManager:unloadMapData()
	removeConsoleCommand("gsBuyFarmland")
	removeConsoleCommand("gsBuyAllFarmlands")
	removeConsoleCommand("gsSellFarmland")
	removeConsoleCommand("gsSellAllFarmlands")
...
function FarmlandManager:consoleCommandBuyFarmland(farmlandId)
	if (g_currentMission:getIsServer() or g_currentMission.isMasterUser) and g_currentMission:getIsClient() then
		...
		if farmlandId == nil then
			return "Invalid farmland id. Use gsBuyFarmland <farmlandId>"
		end
...
function FarmlandManager:consoleCommandSellFarmland(farmlandId)
	if (g_currentMission:getIsServer() or g_currentMission.isMasterUser) and g_currentMission:getIsClient() then
		...
		if farmlandId == nil then
			return "Invalid farmland id. Use gsSellFarmland <farmlandId>"
		end
