...
function WeedMission:new(isServer, isClient, customMt)
	...
	self.completionFilter:setValueCompareParams("equal", 0)
...
function WeedMission.canRunOnField(field, sprayFactor, fieldSpraySet, fieldPlowFactor, limeFactor, maxWeedState)
