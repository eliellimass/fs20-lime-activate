...
if g_isConsoleSimulationActive then
	...
	local oldMeshNetworkGetNodeStatusForApp = meshNetworkGetNodeStatusForApp

	function meshNetworkGetNodeStatusForApp(platformNodeId, property)
		if property == "voice" then
			return allSpeakersTalking and 1 or 0
		else
			return oldMeshNetworkGetNodeStatusForApp(platformNodeId, property)
		end
	end
end
